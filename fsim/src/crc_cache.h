...
class CRC_CACHE
{
  ...
  private:
    ...
    Addr_t GetCacheLinAddr( Addr_t tag, UINT32 setIndex) { return ((((tag << indexShift) | setIndex)) << lineShift); }
  ...
  public:
    ...
    CACHE_REPLACEMENT_STATE* get_repl_object()
    {
        return cacheReplState;
    }
